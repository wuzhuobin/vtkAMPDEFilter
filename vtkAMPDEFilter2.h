 /**
 * @file		QvtkProject\Src\Filter\vtkAMPDEFilter2.h
 * @language	C++
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 */
#ifndef __VTK_AMPDE_FILTER2_H__
#define __VTK_AMPDE_FILTER2_H__
#pragma once
// me 
#include "vtkampdefilter_export.h"
// vtk
#include <vtkPolyDataAlgorithm.h>
class vtkMarchingCubes;
class vtkImageData;
/**
 * @class	vtkAMPDEFilter2
 ...
 * had different intensity distribution. Since then,  vtkAMPDEFilter2#ResampleSize, 
 * vtkAMPDEFilter2#KMeans, vtkAMPDEFilter2#AluminiMean, parameters was added to this filter. 
...
class VTKAMPDEFILTER_EXPORT vtkAMPDEFilter2 : public vtkPolyDataAlgorithm
{
public:
	/**
	 * @fn	static vtkAMPDEFilter2* New();
	 * @brief	static vtk New() method; 
	 * @static
	 * @return	A vtkAMPDEFilter2 pointer.
	 */
	static vtkAMPDEFilter2* New();
	/**
	 * @brief	vtkTypeMacro
	 */
	vtkTypeMacro(vtkAMPDEFilter2, vtkPolyDataAlgorithm);
	/**
...
protected:
	 ...
	 * @brief	Destructor.
	 */
	virtual ~vtkAMPDEFilter2() VTK_OVERRIDE;
...
private:
	vtkAMPDEFilter2(const vtkAMPDEFilter2&) VTK_DELETE_FUNCTION;
	void operator=(const vtkAMPDEFilter2&) VTK_DELETE_FUNCTION;
};

#endif // !__VTK_AMPDE_FILTER2_H__
